...
#define LED_RFID_OFF	HAL_GPIO_WritePin(LED_RFID_GPIO_Port, LED_RFID_Pin,	GPIO_PIN_SET)			//PIN_6 //red led
#define LED_RFID_ON		HAL_GPIO_WritePin(LED_RFID_GPIO_Port, LED_RFID_Pin,	GPIO_PIN_RESET)		//PIN_6 //red led
